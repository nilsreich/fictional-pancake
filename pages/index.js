      ...
      <div className="flex-1">
        <div className="flex">
          <div className="flex w-min whitespace-nowrap border-r border-t-2 border-t-blue-600 border-gray-300 bg-white py-2 pl-4 pr-2 text-sm">
            <div className="">HBFs Klassenarbeit</div>
        ...
        <div className="flex ">
          <div className="flex-1 ml-4">
            ...
            <div>
              Addiere die folgenden Zahlen{" "}
              <svg
                className="inline-block w-3.5 h-3.5 text-gray-600 ml-1 "
                viewBox="0 0 15 15"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <div className="ml-4 py-0.5 flex items-baseline">a) 4+2</div>

            <div className="ml-4 py-0.5">b) 87+54</div>
            <div className="ml-4 py-0.5">c) 56+23</div>
            <div className="ml-4 py-0.5">d) 34+86</div>
          </div>
          <div className="border-l h-screen w-60 -mt-8">
            <div className="text-xs border-b uppercase  py-1 flex">
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 15"
            ...
            <div className="text-xs  uppercase  py-1 flex">
              <svg
                width="15"
                height="15"
                viewBox="0 0 15 15"
              ...
              <div className="font-bold">Bibliothek</div>
            </div>

            <div className="flex items-center border border-gray-300 mx-4 justify-between mt-2">
              <div>
                <input
                  type="text"
                  className="px-1 w-32 text-sm"
            ...
            <div className=" mx-4 py-2 mt-2">
              <div className="text-sm">Addiere die folgenden Zahlen</div>
              <div>a) 4+2</div>
              <div>b) 87+54</div>
              <div>c) 56+23</div>
              <div>d) 34+86</div>
              <div className="flex justify-end">
                <div>
                  <button
                    disabled
                    className="text-[0.6rem] uppercase text-white bg-blue-600 px-2 py-0.5"
                  >
                    {" "}
                    einfügen{" "}
                  </button>
            ...
            <hr className="w-12 mx-auto border-gray-300" />
            <div className=" mx-4 py-2 hover:bg-slate-50">
              <div className="text-sm">Berechne die Summen</div>
              <div>a) 4+2</div>
              <div>b) 87+54</div>
              <div>c) 56+23</div>
              <div>d) 34+86</div>
              <div className="flex justify-end">
                <div>
                  <button className="text-[0.6rem] uppercase bg-blue-600 text-white px-2 py-0.5">
                    {" "}
                    einfügen{" "}
                  </button>
                </div>
