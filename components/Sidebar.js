export default function Sidebar() {
  ...
  return (<>
    <div className="flex h-screen flex-col justify-between border-r border-gray-300">
		<div>
			<div className="ml-1 mr-1 py-1">
				<svg xmlns="http://www.w3.org/2000/svg" className="m-2 h-5 w-5 text-gray-600" fill="none" viewBox="0 0 15 15">
			...
			<div className="border-blue-500 border-l-2 pl-1 py-1">
				<svg xmlns="http://www.w3.org/2000/svg" className="m-2 h-5 w-5" fill="none" viewBox="0 0 15 15" strokeWidth="0" stroke="black">
			...
			<div className="ml-1 py-1">
				<svg xmlns="http://www.w3.org/2000/svg" className="m-2 h-6 w-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
					<path strokeLinecap="round" strokeLinejoin="round" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /> </svg>
			</div>
			<div className="ml-1 py-1">
				<svg xmlns="http://www.w3.org/2000/svg" className="m-2 h-6 w-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
