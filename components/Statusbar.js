export default function Statusbar() {
  return (
    <div className="absolute bottom-0 items-center w-full flex bg-white border-t border-gray-300 text-xs">
      <div className="text-white bg-blue-600 py-1 px-4">
<div className="tracking-wide">Sasu</div>
      </div>
      <div className="flex-1 bg-white text-right px-4 border-r border-gray-300">
        erstellt: 04.05.22{" "}
      </div>

      <div className=" bg-white text-right px-4 border-r border-gray-300">geändert: 05.05.22, 09:10</div>
